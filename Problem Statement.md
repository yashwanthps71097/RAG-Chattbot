...
### 1. Corpus Definition
The corpus is limited to the following 5 active HDFC Mutual Fund scheme pages on Groww:
...
- Answer facts-only queries, such as:
  ...
  - Benchmark index
  - Fund management details (e.g., fund manager name, tenure, education, and experience)
